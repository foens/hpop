namespace OpenPOP.POP3
{
	...
	/// 
	/// Used to keep track of which state the <see cref="POPClient"/> is in.
	/// </summary>
	internal enum ConnectionState
	{
		/// <summary>
		/// This is when the POPClient is not even connected to the server
		/// </summary>
		Disconnected,
		...
		/// <summary>
		/// This is when the server has been given user crefendtials, and we are allowed
